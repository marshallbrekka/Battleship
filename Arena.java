...
public class Arena extends JPanel {
    ...
    private ImageIcon open = new ImageIcon(loadImage("img/open.png"));

    private ImageIcon selected = new ImageIcon(loadImage("img/selected.png"));
    private ImageIcon hit = new ImageIcon(loadImage("img/hit.png"));
    private ImageIcon miss = new ImageIcon(loadImage("img/miss.png"));
    private ImageIcon oceanImg = new ImageIcon(loadImage("img/ocean.png"));
    ...
    private void makeShips(boolean positionShips) {
        String[] paths = {"img/ptboat.png", "img/destroyer.png",
            "img/submarine.png", "img/battleship.png", "img/carrier.png",
            "img/ptboat_s.png", "img/destroyer_s.png", "img/submarine_s.png",
            "img/battleship_s.png", "img/carrier_s.png", "img/ptboat_r.png",
            "img/destroyer_r.png", "img/submarine_r.png",
            "img/battleship_r.png", "img/carrier_r.png",
            "img/ptboat_s_r.png", "img/destroyer_s_r.png",
            "img/submarine_s_r.png", "img/battleship_s_r.png",
            "img/carrier_s_r.png"};
