...
public class Channel {
    ...
    public void sendFleet(Fleet fleet) {
        try {
            out.writeInt(SocketLanguage
                    .createCode(SocketLanguage.MESSAGE_CODES.FLEET));
    ...
    public void sendShot(ShotLocation shot) {
        try {
            out.writeInt(SocketLanguage
                    .createCode(SocketLanguage.MESSAGE_CODES.FIRE));
    ...
    public void joinGame(String name) {
        try {
            out.writeInt(SocketLanguage
                    .createCode(SocketLanguage.MESSAGE_CODES.JOIN_GAME));
    ...
    public void exitGame() {
        try {
            out.writeInt(SocketLanguage
                    .createCode(SocketLanguage.MESSAGE_CODES.EXIT_GAME));
            out.flush();
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    public void playAgain() {
        try {
            out.writeInt(SocketLanguage
                    .createCode(SocketLanguage.MESSAGE_CODES.PLAY_AGAIN));
            out.flush();
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    public void gameJoined() {
        try {
            out.writeInt(SocketLanguage
                    .createCode(SocketLanguage.MESSAGE_CODES.GAME_JOINED));
            out.flush();
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    public void gameRejected() {
        try {
            out.writeInt(SocketLanguage
                    .createCode(SocketLanguage.MESSAGE_CODES.GAME_REJECTED));
            out.flush();
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        ...
        public void run() {
            ...
            while (active) {
                ...
                try {
                    ...
                    if (bytes == 0)
                        continue;
                    SocketLanguage.MESSAGE_CODES code = SocketLanguage
                            .getCode(in.readInt());
